...
export default class SharePoinApiCrud extends React.Component<ISharePoinApiCrudProps, {}> {
  public render(): React.ReactElement<ISharePoinApiCrudProps> {
    ...
    return (
      <section className={`${styles.sharePoinApiCrud} ${hasTeamsContext ? styles.teams : ''}`}>
